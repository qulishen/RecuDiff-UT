...
class SAM(nn.Module):
    def __init__(self, n_feat, kernel_size=3, bias=True):
        ...
        self.conv2 = conv(n_feat, 6, kernel_size, bias=bias)
        self.conv3 = conv(6, n_feat, kernel_size, bias=bias)
...
class HINet(nn.Module):
    ...
    def __init__(self, in_chn=6, wf=64, depth=5,img_size=512,relu_slope=0.2, hin_position_left=0, hin_position_right=4,**kwargs):
    ...
    def forward(self, x):
        ...
        zeros = torch.zeros((b, 3, h, w), dtype=x.dtype, device=x.device)
