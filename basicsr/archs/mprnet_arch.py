...
class MPRNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=24, scale_unetfeats=20, scale_orsnetfeats=16, num_cab=8, kernel_size=3, reduction=4, bias=False,img_size=512,**kwargs):
